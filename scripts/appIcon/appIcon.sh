...
dev_ios_destination_folder_path="../../ios/RNInstaClone/Images.xcassets/AppIconDev.appiconset"
...
prod_ios_destination_folder_path="../../ios/RNInstaClone/Images.xcassets/AppIcon.appiconset"
